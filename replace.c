...
int replace_in_file(const char *filename,//replacement fucntion
                    ...
                    int replace_only_one,//if 1, replace only first occurrence; if 0, replace all
...

{
    ...
    if (!in) //input file by opening and checking for the file 
    ...
    // building a temporary file name
...
//creating a backup option
    ...
    // read file into memory  for the simplicity purpose.
...

    {
        ...
        //fprintf(stderr, "error occurs : file is empty or unreadable.\n");
